...
const DigitalArt = () => {
    ...
    const listTemplate = (digitalArts, layout) => {
        return <div className="grid grid-nogutter">{digitalArts.map((art, index) => itemTemplate(art, layout, index))}</div>;
    };
    ...
    return (
        <div className="card">
            <DataView value={digitalArts} listTemplate={listTemplate} layout={layout} header={header()} />
        </div>
    )
};
